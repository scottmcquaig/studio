...
export default function MockHomePage() {
  ...
  const [userProfile, setUserProfile] = useState<{activePath: string | null}>({ activePath: 'RELATIONSHIPS'});
  ...
  if (!userProfile?.activePath) {
    return (
         <div className="flex flex-col min-h-screen bg-background text-foreground">
          ...
          <BottomNav activeTab="Dashboard" currentDay={currentDay} isMock={true} />
        </div>
    )
  }
